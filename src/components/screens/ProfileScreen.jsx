...
import { LogOut, Heart, Cloud, CloudOff, Edit3 } from 'lucide-react'
...
export default function ProfileScreen({ user, favorites, onLogout, onSelectPlace, onUserUpdate, showToast }) {
      ...
      <div className="px-5 pt-12 pb-6 max-w-3xl mx-auto">
        ...
        <div className="paper-plain p-4 mb-5"
          ...
          <p className="text-[11px] text-usuzumi leading-relaxed font-display">
            {hasSupabase
              ? '資料儲存在 Supabase 雲端。換暱稱會自動更新所有「by XX」紀錄。'
        ...
        <p className="text-[10px] text-center text-usuzumi mt-6 leading-relaxed font-display italic">
          東京散策 · Tokyo Trip Companion v1.3<br />
